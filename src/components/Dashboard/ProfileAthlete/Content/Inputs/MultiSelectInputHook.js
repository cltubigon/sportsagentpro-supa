...
const MultiSelectInputHook = (props) => {
  const { initialValue, value: selections , setValues: setselections, arrayLists: dropList } = props
  ...
  // console.log({ dropList, selections })
...
//   console.log({ defaultValues, dynamicProps })
