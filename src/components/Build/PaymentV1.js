  ...
  return (
    <>
        ...
        <GridItem area={'header'} pb={4}>
            <Flex px={20} flexGrow={1} alignItems={'center'} borderBottom={"2px solid #EBEFF2"}>
                <Flex flexGrow={1} flexDirection={'column'} py={4} >
                    <Text fontSize={'xl'} fontWeight={'semibold'}>Payment</Text>
                    <Text color={"gray.500"} fontSize={'sm'}>Select your payment method and agree to Opendorse terms</Text>
                </Flex>
                <Flex>
        ...
        <GridItem px={20} pt={4} pb={6} area={'footer'}>
            <Flex justifyContent={'flex-start'} bottom={'0'}>
